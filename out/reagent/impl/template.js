...
while (G__6694__i < G__6694__a.length) {G__6694__a[G__6694__i] = arguments[G__6694__i + 0]; ++G__6694__i;}
  args = new cljs.core.IndexedSeq(G__6694__a,0);
} 
...
var or__3759__auto__ = reagent.impl.template.attr_aliases.call(null,n);
...
var G__6697 = o;
(G__6697[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__6698){
var vec__6700 = p__6698;
var id = cljs.core.nth.call(null,vec__6700,(0),null);
var class$ = cljs.core.nth.call(null,vec__6700,(1),null);
var pid = (props["id"]);
...
var pname_6701 = reagent.impl.template.cached_prop_name.call(null,k);
if(!((pname_6701 === "key"))){
(o[pname_6701] = reagent.impl.template.convert_prop_value.call(null,v));
} else {
}
...
var G__6704 = jsprops;
(G__6704["defaultValue"] = value);

(G__6704["value"] = null);

(G__6704["onChange"] = ((function (G__6704,on_change,value){
return (function (p1__6702_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__6702_SHARP_);
});})(G__6704,on_change,value))
);
...
var or__3759__auto__ = reagent.impl.util._STAR_always_update_STAR_;
if(cljs.core.truth_(or__3759__auto__)){
return or__3759__auto__;
} else {
var a1 = (c["props"]["argv"]);
...
var G__6706 = spec;
(G__6706["componentDidUpdate"] = ((function (G__6706){
return (function (){
var c = this;
...
(G__6706["componentWillUnmount"] = ((function (G__6706){
return (function (){
var c = this;
...
var spec = {"displayName": (function (){var or__3759__auto__ = name;
if(cljs.core.truth_(or__3759__auto__)){
return or__3759__auto__;
} else {
...
return (function (p1__6707_SHARP_,p2__6708_SHARP_){
var C = this;
return reagent.impl.template.wrapped_should_update.call(null,C,p1__6707_SHARP_,p2__6708_SHARP_);
...
var vec__6710 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__6710,(0),null);
var id = cljs.core.nth.call(null,vec__6710,(1),null);
var class$ = cljs.core.nth.call(null,vec__6710,(2),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [comp,(cljs.core.truth_((function (){var or__3759__auto__ = id;
if(cljs.core.truth_(or__3759__auto__)){
return or__3759__auto__;
} else {
...
var vec__6712 = reagent.impl.template.parse_tag.call(null,tag);
var comp = cljs.core.nth.call(null,vec__6712,(0),null);
var id_class = cljs.core.nth.call(null,vec__6712,(1),null);
...
var k_6713 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));
var k_SINGLEQUOTE__6714 = (((k_6713 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_6713);
if((k_SINGLEQUOTE__6714 == null)){
} else {
(jsprops["key"] = k_SINGLEQUOTE__6714);
}
...
var n__4646__auto___6715 = a.length;
var i_6716 = (0);
while(true){
if((i_6716 < n__4646__auto___6715)){
(a[i_6716] = reagent.impl.template.as_component.call(null,(a[i_6716]),level_SINGLEQUOTE_));
